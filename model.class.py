...
floder=os.getcwd()
file1='%s/5_fold_1.txt'%floder
file2='%s/5_fold_2.txt'%floder
file3='%s/5_fold_3.txt'%floder
file4='%s/5_fold_4.txt'%floder
file5='%s/5_fold_5.txt'%floder
file6='%s/vaildation_data.txt'%floder
...
for epoch in range(all_epoch):
	model_class.fit(X_train, y_train, sample_weight=np.array(sample_weights_c),batch_size=batch_size,epochs=64,validation_data=(X_val, y_val),verbose=0)
mp = "%s/final_class_model.h5"%floder
model_class.save(mp)
